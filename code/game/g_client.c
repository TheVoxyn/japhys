...
//	areabits = client->areabits;
	...
	//[Physics]
	trap_SendServerCommand (clientNum, "print \"The physics on this server is powered by Newton Game Dynamics.\n"
	                                    "See http://www.newtondynamics.com for more information about this great engine.\n\"");
	//[/Physics]
